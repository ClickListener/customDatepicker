...
package com.example.zhangxu.datepickerpractise.thirdparty.spinnerwheel;
...
//import com.szzc.ucar.utils.UCARDebug;
...
public class WheelHorizontalView extends AbstractWheelView {
    ...
    protected void onScrollTouchedUp() {
        ...
        View itm;
//        UCARDebug.Error(LOG_TAG, " ----- layout: " + mItemsLayout.getMeasuredWidth() + mItemsLayout.getMeasuredHeight());
//        UCARDebug.Error(LOG_TAG, " -------- dumping " + cnt + " items");
        for (int i = 0; i < cnt; i++) {
            itm = mItemsLayout.getChildAt(i);
//            UCARDebug.Error(LOG_TAG, " item #" + i + ": " + itm.getWidth() + "x" + itm.getHeight());
            itm.forceLayout(); // forcing layout without re-rendering parent
        }
//        UCARDebug.Error(LOG_TAG, " ---------- dumping finished ");
    }
